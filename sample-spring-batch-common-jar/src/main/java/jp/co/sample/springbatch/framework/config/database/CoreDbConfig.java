package jp.co.sample.springbatch.framework.config.database;
...
public class CoreDbConfig {
  ...
  /** basePackages. */
  public static final String BASE_PACKAGES = "jp.co.sample.springbatch.framework.data.core.repository";
